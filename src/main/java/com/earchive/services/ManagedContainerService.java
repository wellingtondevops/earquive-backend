...
@Service
public class ManagedContainerService {
	...
	public ManagedGuard insert(ManagedGuard obj) {
		obj.setId(null);
	...
	public ManagedGuard fromDTO(ManagedContainerDTO objDto) {
		...
		ManagedGuard mcont = new ManagedGuard(null, objDto.getName_container(), objDto.getVolumeDescription(), objDto.getcreation(),
				TypeContainer.MANAGEDGUARD, ware, comp, objDto.getNambersRecords());
