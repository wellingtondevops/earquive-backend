...
import com.earchive.services.ManagedContainerService;
import com.earchive.services.exceptions.ObjectNotFoundException;

@RestController
@RequestMapping(value="/mcontainers")
public class ManagedContainerResource {
	
	@Autowired
	private ManagedContainerService service;
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ManagedContainerDTO objDto) {
		ManagedGuard obj = service.fromDTO(objDto);
