...
import com.earchive.services.SimpleContainerService;
import com.earchive.services.exceptions.ObjectNotFoundException;

@RestController
@RequestMapping(value="/scontainers")
public class SimpleContainerResource {
	
	@Autowired
	private SimpleContainerService service;
